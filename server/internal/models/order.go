...
type Order struct {
	...
	Status         string     `gorm:"type:ENUM('in_processing', 'awaiting_payment', 'in_assembly', 'awaiting_shipment', 'in_transit', 'received', 'contacting');default:in_processing;not null" json:"status" form:"status"`
