    ...
    return (
        <Modal
            ...
            <Form form={form} layout="vertical">
                ...
                <Form.Item label="Адрес доставки" name="address" rules={[{ required: true, message: "Введите адрес доставки" }]}>
                    <Input placeholder="г. Москва, ул. Примерная, д. 1" />
                </Form.Item>

                <Form.Item label="Дата доставки" name="delivery_date" rules={[{ required: true, message: "Выберите дату доставки" }]}>
